package com.rodrigodev.xgen4j_table_generator.test.tableIsGeneratedForErrorsWithNumericId.common_code_name_1.common_code_name_2.common_code_name_3_2;
...
public abstract class CName3_2Error extends CName2Error {
    ...
    public static void throwException(String param1, Integer param2, TestObject param3) {
        throw new CName3_2Exception(CODE, createMessage(param1, param2, param3));
    }

    public static void throwException(String param1, Integer param2, TestObject param3, Throwable cause) {
        throw new CName3_2Exception(CODE, createMessage(param1, param2, param3), cause);
    }
