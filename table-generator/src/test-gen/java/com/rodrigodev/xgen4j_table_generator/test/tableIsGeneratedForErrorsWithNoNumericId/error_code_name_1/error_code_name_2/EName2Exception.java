...
import com.rodrigodev.xgen4j_table_generator.test.tableIsGeneratedForErrorsWithNoNumericId.error_code_name_1.EName1Exception;
...
public class EName2Exception extends EName1Exception {
    ...
    protected EName2Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected EName2Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends RootNameException.ExceptionType {
        ...
        protected RootNameException createException(ErrorCode errorCode, String message) {
            return new EName2Exception(errorCode, message);
        }

        @Override
        protected RootNameException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new EName2Exception(errorCode, message, cause);
        }
    }
}
