...
import com.rodrigodev.xgen.test.generation_options.customOptionalClassIsUsedWhenCorrespondingOptionIsSet.custom_c1.custom_c2.CustomC2Error;
 ...
 */
public abstract class CustomC3_2Error extends CustomC2Error {

    public static final ErrorCode CODE = new ErrorCode("custom-c-3-2", CustomC2Error.CODE);
    ...
    public static void throwException(String param1, Integer param2, TestObject param3) {
        throw new CustomC3_2Exception(createMessage(param1, param2, param3));
    }

    public static void throwException(String param1, Integer param2, TestObject param3, Throwable cause) {
        throw new CustomC3_2Exception(createMessage(param1, param2, param3), cause);
    }
