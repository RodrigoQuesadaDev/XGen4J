package com.rodrigodev.xgen4j.test.generation_options.uncheckedExceptionsAreGeneratedWhenCorrespondingOptionIsSetAsFalse.u2_c1.u2_c2.u2_c3_2;

import com.rodrigodev.xgen4j.test.generation_options.uncheckedExceptionsAreGeneratedWhenCorrespondingOptionIsSetAsFalse.u2_c1.u2_c2.U2C2Error;
 ...
 */
public abstract class U2C3_2Error extends U2C2Error {

    public static final ErrorCode CODE = new ErrorCode("u-2-c-3-2", U2C2Error.CODE);
    ...
    public static void throwException(String param1, Integer param2, TestObject param3) {
        throw new U2C3_2Exception(CODE, createMessage(param1, param2, param3));
    }

    public static void throwException(String param1, Integer param2, TestObject param3, Throwable cause) {
        throw new U2C3_2Exception(CODE, createMessage(param1, param2, param3), cause);
    }
