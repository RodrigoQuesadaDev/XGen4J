...
import com.rodrigodev.xgen4j.test.message.descriptionWithCustomObjectThatGeneratesTheMessageCanBeUsed.e1.e2.E2Error;
...
public abstract class E3Error extends E2Error {
    ...
    public static void throwException(TestMessageGeneratorObject generator) {
        throw new E3Exception(CODE, createMessage(generator));
    }

    public static void throwException(TestMessageGeneratorObject generator, Throwable cause) {
        throw new E3Exception(CODE, createMessage(generator), cause);
    }
