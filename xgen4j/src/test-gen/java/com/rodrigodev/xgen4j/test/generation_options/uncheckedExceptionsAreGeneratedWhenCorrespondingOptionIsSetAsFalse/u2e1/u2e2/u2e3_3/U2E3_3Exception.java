package com.rodrigodev.xgen4j.test.generation_options.uncheckedExceptionsAreGeneratedWhenCorrespondingOptionIsSetAsFalse.u2e1.u2e2.u2e3_3;
...
public class U2E3_3Exception extends U2E2Exception {
    ...
    private static class ExceptionType extends U2RootException.ExceptionType {
        ...
        protected U2RootException createException(String message) {
            return new U2E3_3Exception(message);
        }

        @Override
        protected U2RootException createException(String message, Throwable cause) {
            return new U2E3_3Exception(message, cause);
        }
    }

    protected U2E3_3Exception(String message) {
        super(message);
    }

    protected U2E3_3Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
