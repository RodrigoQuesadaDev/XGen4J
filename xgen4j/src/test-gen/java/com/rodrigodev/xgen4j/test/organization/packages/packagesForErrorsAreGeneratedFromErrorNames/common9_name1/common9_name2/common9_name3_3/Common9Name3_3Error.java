 ...
 */
public abstract class Common9Name3_3Error extends Common9Name2Error {

    public static final ErrorCode CODE = new ErrorCode("common-9-name-3-3", Common9Name2Error.CODE);
    ...
    public static void throwException() {
        throw new Common9Name3_3Exception(CODE, createMessage());
    }

    public static void throwException(Throwable cause) {
        throw new Common9Name3_3Exception(CODE, createMessage(), cause);
    }
