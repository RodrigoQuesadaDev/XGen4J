...
public class U2E1Exception extends U2RootException {
    ...
    protected U2E1Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected U2E1Exception(ErrorCode errorCode, String message, Throwable cause) {
