...
public class EA3_3Exception extends EA2Exception {
    ...
    protected EA3_3Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected EA3_3Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends RootException.ExceptionType {
        ...
        protected RootException createException(ErrorCode errorCode, String message) {
            return new EA3_3Exception(errorCode, message);
        }

        @Override
        protected RootException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new EA3_3Exception(errorCode, message, cause);
        }
    }
}
