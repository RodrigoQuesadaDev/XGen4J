package com.rodrigodev.xgen4j.test.info_generation.regularTest.ea1.ea2.ea3_2;
...
public class EA3_2Exception extends EA2Exception {
    ...
    protected EA3_2Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected EA3_2Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends RootException.ExceptionType {
        ...
        protected RootException createException(ErrorCode errorCode, String message) {
            return new EA3_2Exception(errorCode, message);
        }

        @Override
        protected RootException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new EA3_2Exception(errorCode, message, cause);
        }
    }
}
