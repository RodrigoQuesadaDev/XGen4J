...
public class EB3_1Exception extends EB2Exception {
    ...
    protected EB3_1Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected EB3_1Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends RootException.ExceptionType {
        ...
        protected RootException createException(ErrorCode errorCode, String message) {
            return new EB3_1Exception(errorCode, message);
        }

        @Override
        protected RootException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new EB3_1Exception(errorCode, message, cause);
        }
    }
}
