package com.rodrigodev.xgen4j.test.generation_options.java8OptionalClassIsUsedWhenNoOptionIsSet.e1.e2.e3_2;
...
public abstract class E3_2Error extends E2Error {
    ...
    public static void throwException(String param1, Integer param2, TestObject param3) {
        throw new E3_2Exception(CODE, createMessage(param1, param2, param3));
    }

    public static void throwException(String param1, Integer param2, TestObject param3, Throwable cause) {
        throw new E3_2Exception(CODE, createMessage(param1, param2, param3), cause);
    }
