...
public class U2E3_2Exception extends U2E2Exception {
    ...
    protected U2E3_2Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected U2E3_2Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends U2RootException.ExceptionType {
        ...
        protected U2RootException createException(ErrorCode errorCode, String message) {
            return new U2E3_2Exception(errorCode, message);
        }

        @Override
        protected U2RootException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new U2E3_2Exception(errorCode, message, cause);
        }
    }
}
