...
public class BurnedFoodException extends OvenException {
    ...
    protected BurnedFoodException(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected BurnedFoodException(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends HouseException.ExceptionType {
        ...
        protected HouseException createException(ErrorCode errorCode, String message) {
            return new BurnedFoodException(errorCode, message);
        }

        @Override
        protected HouseException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new BurnedFoodException(errorCode, message, cause);
        }
    }
}
