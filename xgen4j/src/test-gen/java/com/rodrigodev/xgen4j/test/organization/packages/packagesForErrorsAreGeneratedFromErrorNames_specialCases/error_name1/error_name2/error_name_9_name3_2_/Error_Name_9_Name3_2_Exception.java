...
public class Error_Name_9_Name3_2_Exception extends ErrorName2Exception {
    ...
    private static class ExceptionType extends RootNameException.ExceptionType {
        ...
        protected RootNameException createException(String message) {
            return new Error_Name_9_Name3_2_Exception(message);
        }

        @Override
        protected RootNameException createException(String message, Throwable cause) {
            return new Error_Name_9_Name3_2_Exception(message, cause);
        }
    }

    protected Error_Name_9_Name3_2_Exception(String message) {
        super(message);
    }

    protected Error_Name_9_Name3_2_Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
