...
public class UE3_3Exception extends UE2Exception {
    ...
    protected UE3_3Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected UE3_3Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends URootException.ExceptionType {
        ...
        protected URootException createException(ErrorCode errorCode, String message) {
            return new UE3_3Exception(errorCode, message);
        }

        @Override
        protected URootException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new UE3_3Exception(errorCode, message, cause);
        }
    }
}
