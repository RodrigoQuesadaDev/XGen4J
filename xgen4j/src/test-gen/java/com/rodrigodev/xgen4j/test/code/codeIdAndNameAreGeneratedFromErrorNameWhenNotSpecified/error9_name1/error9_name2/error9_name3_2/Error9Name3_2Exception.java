...
public class Error9Name3_2Exception extends Error9Name2Exception {
    ...
    protected Error9Name3_2Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected Error9Name3_2Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends Root9NameException.ExceptionType {
        ...
        protected Root9NameException createException(ErrorCode errorCode, String message) {
            return new Error9Name3_2Exception(errorCode, message);
        }

        @Override
        protected Root9NameException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new Error9Name3_2Exception(errorCode, message, cause);
        }
    }
}
