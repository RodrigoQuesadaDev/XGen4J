package com.rodrigodev.xgen4j.test.generation_options.java8OptionalClassIsUsedWhenCorrespondingOptionIsSet.java8e1.java8e2.java8e3_2;
 ...
 */
public abstract class Java8E3_2Error extends Java8E2Error {

    public static final ErrorCode CODE = new ErrorCode("java-8-e-3-2", Java8E2Error.CODE);
    ...
    public static void throwException(String param1, Integer param2, TestObject param3) {
        throw new Java8E3_2Exception(createMessage(param1, param2, param3));
    }

    public static void throwException(String param1, Integer param2, TestObject param3, Throwable cause) {
        throw new Java8E3_2Exception(createMessage(param1, param2, param3), cause);
    }
