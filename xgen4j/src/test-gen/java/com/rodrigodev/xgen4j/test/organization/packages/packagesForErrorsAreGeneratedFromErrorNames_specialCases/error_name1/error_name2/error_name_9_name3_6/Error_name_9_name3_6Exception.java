...
public class Error_name_9_name3_6Exception extends ErrorName2Exception {
    ...
    private static class ExceptionType extends RootNameException.ExceptionType {
        ...
        protected RootNameException createException(String message) {
            return new Error_name_9_name3_6Exception(message);
        }

        @Override
        protected RootNameException createException(String message, Throwable cause) {
            return new Error_name_9_name3_6Exception(message, cause);
        }
    }

    protected Error_name_9_name3_6Exception(String message) {
        super(message);
    }

    protected Error_name_9_name3_6Exception(String message, Throwable cause) {
        super(message, cause);
    }
}
