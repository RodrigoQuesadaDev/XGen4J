package com.rodrigodev.xgen4j.test.organization.packages.packagesForErrorsAreGeneratedFromErrorNames_specialCases.error_name1.error_name2.error_name_9_name3_6;
 ...
 */
public class Error_name_9_name3_6Exception extends ErrorName2Exception {

    public static final ExceptionType TYPE = new ExceptionType();

    protected Error_name_9_name3_6Exception(ErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    protected Error_name_9_name3_6Exception(ErrorCode errorCode, String message, Throwable cause) {
    ...
    private static class ExceptionType extends RootNameException.ExceptionType {
        ...
        protected RootNameException createException(ErrorCode errorCode, String message) {
            return new Error_name_9_name3_6Exception(errorCode, message);
        }

        @Override
        protected RootNameException createException(ErrorCode errorCode, String message, Throwable cause) {
            return new Error_name_9_name3_6Exception(errorCode, message, cause);
        }
    }
}
